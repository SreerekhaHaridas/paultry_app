...
import 'package:paultry_app/forms/transaction_forms/DailyEntry_Editor.dart';
...
class DailyEntryWidget extends StatefulWidget {
  const DailyEntryWidget({Key? key}) : super(key: key);
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          Flexible(
              ...
              child: DateFilter(
                datesSelected: (fromDate1, toDate1) {
                  fromDate = fromDate1;
                  toDate = toDate1;
                  BlocProvider.of<DailyentrylistCubit>(context)
          ...
          Flexible(
            flex: 25,
            child: BlocBuilder<DailyentrylistCubit, DailyentrylistState>(
